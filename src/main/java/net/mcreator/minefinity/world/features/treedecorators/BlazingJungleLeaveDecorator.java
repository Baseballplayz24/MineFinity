...
public class BlazingJungleLeaveDecorator extends LeaveVineDecorator {
	public static final BlazingJungleLeaveDecorator INSTANCE = new BlazingJungleLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("blazing_jungle_tree_leave_decorator");
