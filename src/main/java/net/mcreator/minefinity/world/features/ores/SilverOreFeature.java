...
public class SilverOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("minefinity:silver_ore", FEATURE,
				new OreConfiguration(SilverOreFeatureRuleTest.INSTANCE, MinefinityModBlocks.SILVER_ORE.get().defaultBlockState(), 7));
		PLACED_FEATURE = PlacementUtils.register("minefinity:silver_ore", CONFIGURED_FEATURE,
				List.of(CountPlacement.of(11), InSquarePlacement.spread(),
						HeightRangePlacement.uniform(VerticalAnchor.absolute(1), VerticalAnchor.absolute(127)), BiomeFilter.biome()));
		return FEATURE;
	}
	...
	private static class SilverOreFeatureRuleTest extends RuleTest {
		...
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("minefinity:silver_ore_match"), CUSTOM_MATCH);
		}
