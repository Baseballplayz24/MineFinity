...
import net.mcreator.minefinity.procedures.DiamondHeartItemInInventoryTickProcedure;
import net.mcreator.minefinity.init.MinefinityModTabs;

public class DiamondHeartItem extends Item {
	public DiamondHeartItem() {
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		DiamondHeartItemInInventoryTickProcedure.execute(entity);
	}
}
