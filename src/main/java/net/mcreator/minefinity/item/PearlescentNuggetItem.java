...
public class PearlescentNuggetItem extends Item {
	public PearlescentNuggetItem() {
		super(new Item.Properties().tab(MinefinityModTabs.TAB_MINEFINITY_END).stacksTo(64).rarity(Rarity.COMMON));
	}
