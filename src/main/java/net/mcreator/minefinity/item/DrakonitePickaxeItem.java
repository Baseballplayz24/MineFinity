...
public class DrakonitePickaxeItem extends PickaxeItem {
	public DrakonitePickaxeItem() {
		super(new Tier() {
			public int getUses() {
				return 6144;
			}
		...
		}, 1, -2.4f, new Item.Properties().tab(MinefinityModTabs.TAB_MINEFINITY_END).fireResistant());
	}
}
