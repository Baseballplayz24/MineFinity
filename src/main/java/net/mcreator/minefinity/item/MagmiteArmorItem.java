...
public abstract class MagmiteArmorItem extends ArmorItem {
	public MagmiteArmorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends MagmiteArmorItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "minefinity:textures/models/armor/magmite_layer_1.png";
		}
	}
	...
	public static class Leggings extends MagmiteArmorItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "minefinity:textures/models/armor/magmite_layer_2.png";
		}
	}
