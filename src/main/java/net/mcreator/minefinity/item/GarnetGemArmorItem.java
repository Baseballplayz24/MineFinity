...
public abstract class GarnetGemArmorItem extends ArmorItem {
	public GarnetGemArmorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends GarnetGemArmorItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "minefinity:textures/models/armor/garnet__layer_1.png";
		}
	}
	...
	public static class Leggings extends GarnetGemArmorItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "minefinity:textures/models/armor/garnet__layer_2.png";
		}
	}
